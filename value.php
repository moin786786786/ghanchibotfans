...
array(
array(
"Wo Rooh me Meri Saama Geya,Mujhe Ishq Krna Wo Sikha Geya.",
"Wo Rooh me Meri Saama Geya,Mujhe Ishq Krna Wo Sikha Geya.",
...
$punyu=array(
                   ' Chal Ab Like Comment Back Ker Jaldi >>',
                 'Full Speed Ka Saath >>',
               'Thori Dair Ho Gyi Na >>',
            'Like And Comment time late >>',
          'BOT LIKE LATE >>',
        'Thoda Late Ho gya >>',
      'Like Cmnt Back , I am Waiting >>',
   'Close Kro Jani Me Done >>',
'like And Comment Late >>',
);
$back=array(
' :|] RobOt CReadet <3 Saba Ghanchi <3 >>',
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site=' :|] BOT By  B| GHANCHI BOTTERX  B|
Bot Powered By :v :v (^^^)  (^^^) ';
$true=$ops.'
:3 '.$eps.'
-_- '.$ups.'
